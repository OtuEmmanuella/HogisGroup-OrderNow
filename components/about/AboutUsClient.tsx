...
const AboutUsClient = () => {
  ...
  return (
    <div className="min-h-screen bg-hotel-dark text-white overflow-hidden bg-[#1A1F2C]">
      ...
      >
        <Link href="/home" className="flex items-center gap-2 text-white/80 hover:text-white transition-colors">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <motion.button className="hotel-button group" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                Discover Our Story
                <motion.span
                  initial={{ x: 0 }}
                  animate={{ x: [0, 5, 0] }}
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            >
              ...
              <div className="space-y-6 text-white/80">
                <p className="text-lg">
                  At Hogis Group, we pride ourselves on being the number one hospitality company in Calabar. Our
                  commitment to excellence has made us the preferred destination for dining, entertainment, relaxation,
                  and more.
                </p>

                <p className="text-lg">
                  With a diverse portfolio of businesses including world-class restaurants, the best cinema in town, an
                  electrifying nightclub, premium fitness facilities, luxurious hotel accommodations, a rejuvenating
                  spa, and sophisticated lounges, we offer unparalleled experiences for every occasion.
                </p>

                <div className="pt-4">
                  <div className="flex gap-8">
                    <div>
                      <p className="text-5xl font-serif text-hotel-gold">4+</p>
      ...
      <section id="team-section" ref={teamRef} className="hotel-section bg-hotel-navy py-20 md:py-32">
        <div className="container mx-auto px-4">
          <motion.div
            className="text-center mb-16"
            initial={{ opacity: 0, y: 20 }}
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              ...
              <p className="text-lg text-white/80 mb-8">
                Our commitment to excellence has been recognized with numerous prestigious awards in the hospitality
                industry.
              </p>
      ...
      <section
        ...
        className="hotel-section bg-gradient-to-b from-hotel-[#141E30] to-hotel-[#1A1F2C] py-20 md:py-32"
      >
        <div className="container mx-auto px-4">
          <motion.div
            className="text-center mb-16"
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="h-0.5 w-16 bg-hotel-[#C5B358] mx-auto mb-6"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {locations.map((location, index) => (
              ...
              >
                ...
                <div className="absolute top-4 right-4 bg-hotel-[#C5B358]/90 text-hotel-[#1A1F2C] px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1">
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-6">
                  <div className="space-y-2 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <div className="pt-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                      <Button
                        variant="outline"
                        className="border-hotel-gold text-hotel-gold hover:bg-hotel-gold hover:text-hotel-dark"
                      >
                        View Details
                      </Button>
                    </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <motion.p
              ...
              transition={{ duration: 0.8, delay: 0.2 }}
            >
              Indulge in the ultimate hospitality experience at Hogis Group. Book your stay or reserve a table today.
            </motion.p>
      ...
      <footer className="bg-hotel-dark py-12 border-t border-white/10">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-white/70 max-w-md mb-6">
                Setting the standard for luxury hospitality in Calabar since 2005. Experience excellence in every
                detail.
              </p>
              <div className="flex gap-4">
                <Link href="#" className="text-white/70 hover:text-hotel-gold transition-colors">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/50 text-sm">© {new Date().getFullYear()} Hogis Group. All rights reserved.</p>
