...
const AdminPromotionsPage = () => {
  ...
  const [isDeleting, setIsDeleting] = useState<Id<"promotions"> | null>(null); // Track which promo is being deleted
  ...
  const handleDelete = async (promoId: Id<"promotions">) => {
    ...
    try {
      setIsDeleting(promoId); // Set the loading state for this promotion
      ...
      setIsDeleting(null); // Clear the loading state
    }
  };
    ...
    <div className="container mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      {isLoading ? (
        ...
        <PromotionsTable 
          ...
          isDeletingId={isDeleting} // Pass the currently deleting promotion ID
        />
      ) : (
