          ...
          <AccordionItem key={category._id} value={category._id}>
                  ...
                  <AlertDialog>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          This will permanently delete the category &ldquo;{category.name}&rdquo; and ALL menu items within it. This action cannot be undone.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
            ...
            <AccordionContent>
              ...
              <AdminMenuItemsList
                ...
                onAddItem={() => openAddMenuItemDialog(category._id)}
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete the menu item &ldquo;{item.name}&rdquo;. This action cannot be undone.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
