  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md max-h-[85vh] flex flex-col">
        ...
        <div className="py-4 space-y-4 overflow-y-auto flex-grow pr-3">
           {/* Zone Selection */}
           <div>
             ...
             {!activeZones ? (
               ...
               <div className="mt-2 max-h-60 overflow-y-auto pr-2 border rounded-md">
                 <RadioGroup
                 ...
                 >
                   {activeZones.map((zone) => (
                     <div key={zone._id} className="flex items-center space-x-2 border p-3 rounded-md mb-2 last:mb-0">
                       ...
                       <Label htmlFor={zone._id} className="flex flex-col flex-grow cursor-pointer">
                         ...
                         <span className="text-sm text-muted-foreground">
                           {zone.description} - Base: {formatCurrency(zone.baseFee)}, Peak: {formatCurrency(zone.peakFee)}
                         </span>
                       </Label>
                     </div>
                   ))}
