...
function Header() {
  ...
  const linkCartId = activeSharedCartId || mySharedCart?._id;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <nav className="hidden md:flex items-center gap-4">
            ...
            {/* Show Return to Group Order button if there is an active or initiated cart */}
            {linkCartId && (
                <Link href={`/shared-cart/${linkCartId}`} passHref>
