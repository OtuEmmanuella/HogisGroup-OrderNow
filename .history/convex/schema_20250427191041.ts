...
export default defineSchema({
  ...
  orders: defineTable({
    ...
    deliveryZoneId: v.optional(v.id("deliveryZones")), // Link to the selected delivery zone
    deliveryFee: v.optional(v.number()), // Delivery fee applied (in kobo/cents)
  })
  ...
  sharedCarts: defineTable({
    ...
    // Add fields for delivery zone selection
    deliveryZoneId: v.optional(v.id("deliveryZones")), // Link to the selected delivery zone
    deliveryFee: v.optional(v.number()), // Delivery fee applied (in kobo/cents)
    // Add fields for delivery address details
    deliveryStreetAddress: v.optional(v.string()), 
    deliveryPhoneNumber: v.optional(v.string()), 
  })
